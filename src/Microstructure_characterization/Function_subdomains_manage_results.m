function [RVE] = Function_subdomains_manage_results(Property_eachsubdomain, Property_subdomains_statistics, Size_RVE, derivative_convergence, relativedifference_convergence, Size_convergence, RVEparameters,RVE,k_RVE,number_phase,number_phase_todo,infovol,p)
...
if strcmp(RVEparameters.type,'G')
    Variable_name_table={['Equivalent_cubicroot_length_' infovol.unit],'n/a',['Length_' infovol.unit]};
elseif strcmp(RVEparameters.type,'C') || strcmp(RVEparameters.type,'H')
    Variable_name_table={['Equivalent_cubicroot_length_' infovol.unit],['Equivalent_squareroot_length_' infovol.unit],'n/ a'};
elseif strcmp(RVEparameters.type,'D')
    Variable_name_table={['Equivalent_cubicroot_length_' infovol.unit],'n/a',['Length_' infovol.unit]};
else
    Variable_name_table={['Equivalent_cubicroot_length_' infovol.unit],'n/a','n/ a'};
end
...
Variable_name_table = [Variable_name_table 'Number_of_subdomain','Mean','Standard_deviation','Relative_standard_deviation_percents','Minimum','Maximum','Standard error of the mean','95% confidence interval'];
