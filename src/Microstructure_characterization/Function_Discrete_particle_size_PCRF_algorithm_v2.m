function [D_PSD_particle_size, Label_lake, Repulsive_matrix, Repulsive_matrix_sign] = Function_Discrete_particle_size_PCRF_algorithm_v2(binary_phase,cpsd_refining,downscaling_factor, details_convergence,visualize_2D,exponent_law,max_dist)
...
for current_voxel_border=1:1:number_voxel_border
    ...
    if progress_force_calculation>=next_step_display
