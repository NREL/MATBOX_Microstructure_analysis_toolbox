function [D_PSD_particle_size, Label_lake, Repulsive_matrix, Repulsive_matrix_sign] = Function_Discrete_particle_size_PCRF_algorithm_v3(binary_phase,cpsd_refining,downscaling_factor, erosion_distance, percluster, details_convergence,visualize_2D,exponent_law,max_dist)
...
if downscaling_factor~=1
    ...
    tmp=randi(255,n+1,3)/255;
    tmp(1,:)=[1.0 1.0 1.0];
    figure; imagesc(Label_lake_r); axis equal; axis tight; colormap(tmp);
    pause(0.1);
