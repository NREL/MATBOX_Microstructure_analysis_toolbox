function [D_PSD_particle_size, Label_lake, Repulsive_matrix, Repulsive_matrix_sign] = Function_Discrete_particle_size_PCRF_algorithm(binary_phase,cpsd_refining,details_convergence,visualize_2D,exponent_law,max_dist)
