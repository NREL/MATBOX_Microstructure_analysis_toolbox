function [tube_phase, tube_id, tube_skeleton] = function_upscale_tube(tube_id,tubes,domain_size,scaling_factors,Bezier_pars,cropp,shape,n_tube,volumefraction)
